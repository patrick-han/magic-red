...
CPUModel::CPUModel(const char* fileName, bool isBinary, GfxDevice& _gfxDevice, TextureCache& _textureCache) : m_gfxDevice(_gfxDevice), m_textureCache(_textureCache) {
