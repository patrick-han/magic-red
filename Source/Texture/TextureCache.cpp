...
[[nodiscard]] GPUTextureId TextureCache::add_texture(const GfxDevice& gfxDevice, const void* textureData, const TextureSize& textureSize) {
   ...
   upload_texture(textureData, gfxDevice, textureSize);
   return textureId;
}
...
void TextureCache::upload_texture(const void* textureData, const GfxDevice& gfxDevice, const TextureSize& textureSize) {
